...
module.exports = {
  ...
  onChat: async function ({ api, event, usersData }) {
    try {
      ...
      // Trigger words
      const triggers = ["baby", "bot", "Rudro", "jan", "xan", "জান", "বট", "বেবি"];
      if (triggers.includes(raw)) {
        const greetings = [
          "Bolo baby 💬", "হুম? বলো 😺", "হ্যাঁ জানু 😚", "শুনছি বেবি 😘",
          "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈", "Boss বল boss😼",
          "আমাকে ডাকলে ,আমি কিন্তু কিস করে দিবো😘", "দূরে যা, তোর কোনো কাজ নাই, Bolo baby 💬",
        "হুম? বলো 😺",
        "হ্যাঁ জানু 😚",
        "শুনছি বেবি 😘",
        ...
        "jang hanga korba😒😬",
        "আমাকে না ডেকে আমার বস Rudro কে একটা জি এফ দাও-😽🫶🌺",
        "মাইয়া হলে চিপায় আসো 🙈😘",
        "-𝙂𝙖𝙮𝙚𝙨-🤗-যৌবনের কসম দিয়ে আমাকে 𝐁𝐥𝐚𝐜𝐤𝐦𝐚𝐢𝐥 করাছে-🥲🤦‍♂️🤧",
        "-আমার গল্পে তোমার নানি সেরা-🙊🙆‍♂️",
        "বট বট করিস না তো 😑,মেয়ে হলে আমার বসের ইনবক্স এ গিয়ে উম্মা দিয়ে আসো , এই নাও বসের ইনবক্স লিংক www.dure_giye_mor",
        "এত ডাকাডাকি না করে মুড়ির সাথে গাঞ্জা মিশাইয়া খাইয়া মরে যা",
        "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস Rudro এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸",
        "সুন্দর মাইয়া মানেই-🥱আমার বস Rudro' এর বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸",
        ...
        "তোর কি চোখে পড়ে না আমি বস Rudro এর সাথে ব্যাস্ত আসি😒",
        ...
        "কিরে বলদ এত ডাকাডাকি করিস কেনো 🐸, তোরে কি শয়তানে লারে ??", শুধু bot bot করিস 😉😋🤣"
        ];
